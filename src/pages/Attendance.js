...
export default function Attendance() {
  ...
  useEffect(() => {
    if (tab === "report") {
      API.get("/users?role=student")
        .then((res) => setReportStudents(res.data.users || []))
        .catch(() => {});
    }
  }, [tab]);
  ...
  const fetchSessions = useCallback(() => {
    ...
    if (sessionFilter.subjectId)
      params.set("subjectId", sessionFilter.subjectId);
    if (sessionFilter.department)
      params.set("department", sessionFilter.department);
  ...
  const fetchReport = async () => {
    ...
    try {
      const res = await API.get(
        `/attendance/report/student/${selectedStudent}`,
      );
  ...
  const statusBg = (s) =>
    s === "present" ? "#dcfce7" : s === "late" ? "#fef3c7" : "#fee2e2";
          ...
          <form onSubmit={handleMarkSubmit}>
            ...
            >
              {[
                ...
                <div key={f.name}>
                  ...
                  {f.type === "select" ? (
                    <select
                      value={markForm[f.name]}
                      onChange={(e) =>
                        setMarkForm((p) => ({ ...p, [f.name]: e.target.value }))
                      }
                      style={{
                        width: "100%",
                        padding: "8px 10px",
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setMarkForm((p) => ({ ...p, subjectId: e.target.value }))
                  }
                  style={{
                    width: "100%",
                    padding: "8px 10px",
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setMarkForm((p) => ({ ...p, notes: e.target.value }))
                }
              ...
              {studentsLoading ? (
                ...
                >
                  {markForm.department
                    ...
                    : "Enter a department to load students."}
                </p>
              ) : (
                <div
                  style={{
            ...
            <button
              type="submit"
              disabled={
                markLoading || students.length === 0 || !markForm.subjectId
              }
              style={{
                padding: "12px 28px",
                background: "#6366f1",
        ...
        >
          ...
          >
            <input
              ...
              onChange={(e) =>
                setSessionFilter((p) => ({ ...p, date: e.target.value }))
              }
              style={{
                padding: "8px 12px",
                borderRadius: 8,
            ...
            />
            <select
              value={sessionFilter.subjectId}
              onChange={(e) =>
                setSessionFilter((p) => ({ ...p, subjectId: e.target.value }))
              }
              style={{
                padding: "8px 12px",
                borderRadius: 8,
            ...
            <input
              value={sessionFilter.department}
              onChange={(e) =>
                setSessionFilter((p) => ({ ...p, department: e.target.value }))
              }
                  ...
                  {sessions.map((s) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: "10px 14px", color: "#111" }}>P{s.period}</td>
                        <td style={{ padding: "10px 14px", color: "#111" }}>{s.department}</td>
                        <td style={{ padding: "10px 14px", color: "#111" }}>
                          <span
                            style={{
                              fontWeight: 700,
                  ...
                  >
                    ...
                    <div
                      style={{
                        fontSize: 24,
                        fontWeight: 800,
                        color: r.percentage >= 75 ? "#22c55e" : "#ef4444",
                      }}
                    >
                      {r.percentage}%
                    </div>
